...
COMMANDS = {
    Action.TOGGLE_PLAY: ExtensionResultItem(icon='images/icon.png',
                                            name="Toggle",
                                            description="Pause/Play",
                                            on_enter=ExtensionCustomAction(
                                                data=CommandData(Action.TOGGLE_PLAY),
                                                keep_app_open=False)),
    Action.PLAY: ExtensionResultItem(icon='images/icon.png',
                                     name="Play",
                                     description="play",
                                     on_enter=ExtensionCustomAction(data=CommandData(Action.PLAY),
                                                                    keep_app_open=False)),
    Action.PAUSE: ExtensionResultItem(icon='images/icon.png',
                                      name="Pause",
                                      description="Pause",
                                      on_enter=ExtensionCustomAction(data=CommandData(Action.PAUSE),
                                                                     keep_app_open=False)),
    Action.NEXT: ExtensionResultItem(icon='images/icon.png',
                                     name="Next",
                                     description="Next",
                                     on_enter=ExtensionCustomAction(data=CommandData(Action.NEXT),
                                                                    keep_app_open=False)),
    Action.PREVIOUS: ExtensionResultItem(icon='images/icon.png',
                                         name="Previous",
                                         description="Previous",
                                         on_enter=ExtensionCustomAction(data=CommandData(Action.PREVIOUS),
                                                                        keep_app_open=False)),
    Action.CLEAR: ExtensionResultItem(icon='images/icon.png',
                                      name="Clear",
                                      description="Clear queue",
                                      on_enter=ExtensionCustomAction(data=CommandData(Action.CLEAR),
                                                                     keep_app_open=False)),
    Action.ADD_SONG: ExtensionResultItem(icon='images/icon.png',
                                         name="song-add",
                                         description="Add Song",
                                         on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                        keep_app_open=True)),
    Action.ADD_ALBUM: ExtensionResultItem(icon='images/icon.png',
                                          name="album-add",
                                          description="Add Album",
                                          on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                         keep_app_open=True)),
    Action.ADD_ARTIST: ExtensionResultItem(icon='images/icon.png',
                                           name="artist-add",
                                           description="Add Artist",
                                           on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                          keep_app_open=True)),
    Action.INSERT_SONG: ExtensionResultItem(icon='images/icon.png',
                                            name="song-insert",
                                            description="Insert Song",
                                            on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                           keep_app_open=True)),
    Action.INSERT_ALBUM: ExtensionResultItem(icon='images/icon.png',
                                             name="album-insert",
                                             description="Insert Album",
                                             on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                            keep_app_open=True)),
    Action.INSERT_ARTIST: ExtensionResultItem(icon='images/icon.png',
                                              name="artist-insert",
                                              description="Insert Artist",
                                              on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                             keep_app_open=True)),
    Action.ADD_FOLDER: ExtensionResultItem(icon='images/icon.png',
                                           name="folder-add",
                                           description="Add Folder",
                                           on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                          keep_app_open=True)),
    Action.INSERT_FOLDER: ExtensionResultItem(icon='images/icon.png',
                                              name="folder-insert",
                                              description="Insert Folder",
                                              on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                             keep_app_open=True)),
    Action.ADD_PLAYLIST: ExtensionResultItem(icon='images/icon.png',
                                             name="playlist-add",
                                             description="Add Folder",
                                             on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                            keep_app_open=True)),
    Action.INSERT_PLAYLIST: ExtensionResultItem(icon='images/icon.png',
                                                name="playlist-insert",
                                                description="Insert Playlist",
                                                on_enter=ExtensionCustomAction(data=CommandData(Action.NONE),
                                                                               keep_app_open=True)),

    Action.ADD_TO_PLAYLIST: ExtensionResultItem(icon='images/icon.png',
